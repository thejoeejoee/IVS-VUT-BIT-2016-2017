...
class TestSolver(TestCase):
    ...
    def test_compute_basic_expression_add(self):
        self.assertEqual(
    ...
    def test_compute_basic_expression_subtract(self):
        self.assertEqual(
            self.solver.compute('40 - 2'),
            38,
    ...
    def test_compute_basic_expression_multiply(self):
        self.assertEqual(
    ...
    def test_compute_basic_expression_divide(self):
        self.assertEqual(
    ...
    def test_compute_bracketed_expression_add(self):
        self.assertEqual(
    ...
    def test_compute_bracketed_expression_subtract(self):
        self.assertEqual(
    ...
    def test_compute_bracketed_expression_multiply(self):
        self.assertEqual(
    ...
    def test_compute_bracketed_expression_divide(self):
        self.assertEqual(
